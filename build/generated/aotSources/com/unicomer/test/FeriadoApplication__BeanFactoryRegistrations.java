...
import com.unicomer.test.application.config.BearerTokenSupplier__BeanDefinitions;
import com.unicomer.test.application.config.CustomPrefixBearerTokenResolver__BeanDefinitions;
import com.unicomer.test.application.config.ExceptionHandleFilter__BeanDefinitions;
import com.unicomer.test.application.config.ExceptionHandleInterceptor__BeanDefinitions;
import com.unicomer.test.application.config.JpaConfiguration__BeanDefinitions;
import com.unicomer.test.application.config.ObjectMapperConfiguration__BeanDefinitions;
import com.unicomer.test.application.config.ObservationLogsConfiguration__BeanDefinitions;
import com.unicomer.test.application.config.QueryFormattingConfiguration__BeanDefinitions;
import com.unicomer.test.application.config.SecurityConfiguration__BeanDefinitions;
import com.unicomer.test.application.config.WebMvcConfiguration__BeanDefinitions;
import com.unicomer.test.application.feriado.controller.FeriadoController__BeanDefinitions;
import com.unicomer.test.application.feriado.service.FeriadoService__BeanDefinitions;
import com.unicomer.test.application.user.config.UserServiceConfiguration__BeanDefinitions;
import com.unicomer.test.application.user.controller.ProfileController__BeanDefinitions;
import com.unicomer.test.application.user.controller.UserController__BeanDefinitions;
import com.unicomer.test.application.user.service.ProfileService__BeanDefinitions;
import com.unicomer.test.domain.feriado.FeriadoRepository__BeanDefinitions;
import com.unicomer.test.domain.user.UserRepository__BeanDefinitions;
 ...
 */
@Generated
public class FeriadoApplication__BeanFactoryRegistrations {
  /**
  ...
  public void registerBeanDefinitions(DefaultListableBeanFactory beanFactory) {
    ...
    beanFactory.registerBeanDefinition("feriadoApplication", FeriadoApplication__BeanDefinitions.getFeriadoApplicationBeanDefinition());
    beanFactory.registerBeanDefinition("bearerTokenSupplier", BearerTokenSupplier__BeanDefinitions.getBearerTokenSupplierBeanDefinition());
    beanFactory.registerBeanDefinition("customPrefixBearerTokenResolver", CustomPrefixBearerTokenResolver__BeanDefinitions.getCustomPrefixBearerTokenResolverBeanDefinition());
    beanFactory.registerBeanDefinition("exceptionHandleFilter", ExceptionHandleFilter__BeanDefinitions.getExceptionHandleFilterBeanDefinition());
    beanFactory.registerBeanDefinition("exceptionHandleInterceptor", ExceptionHandleInterceptor__BeanDefinitions.getExceptionHandleInterceptorBeanDefinition());
    beanFactory.registerBeanDefinition("jpaConfiguration", JpaConfiguration__BeanDefinitions.getJpaConfigurationBeanDefinition());
    beanFactory.registerBeanDefinition("objectMapperConfiguration", ObjectMapperConfiguration__BeanDefinitions.getObjectMapperConfigurationBeanDefinition());
    beanFactory.registerBeanDefinition("observationLogsConfiguration", ObservationLogsConfiguration__BeanDefinitions.getObservationLogsConfigurationBeanDefinition());
    beanFactory.registerBeanDefinition("queryFormattingConfiguration", QueryFormattingConfiguration__BeanDefinitions.getQueryFormattingConfigurationBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("webMvcConfiguration", WebMvcConfiguration__BeanDefinitions.getWebMvcConfigurationBeanDefinition());
    beanFactory.registerBeanDefinition("feriadoController", FeriadoController__BeanDefinitions.getFeriadoControllerBeanDefinition());
    beanFactory.registerBeanDefinition("feriadoService", FeriadoService__BeanDefinitions.getFeriadoServiceBeanDefinition());
    beanFactory.registerBeanDefinition("userServiceConfiguration", UserServiceConfiguration__BeanDefinitions.getUserServiceConfigurationBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("objectMapper", ObjectMapperConfiguration__BeanDefinitions.getObjectMapperBeanDefinition());
    beanFactory.registerBeanDefinition("observationTextPublisher", ObservationLogsConfiguration__BeanDefinitions.getObservationTextPublisherBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("jwtDecoder", SecurityConfiguration__BeanDefinitions.getJwtDecoderBeanDefinition());
    beanFactory.registerBeanDefinition("jwtEncoder", SecurityConfiguration__BeanDefinitions.getJwtEncoderBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("userService", UserServiceConfiguration__BeanDefinitions.getUserServiceBeanDefinition());
    beanFactory.registerBeanDefinition("userApplicationService", UserServiceConfiguration__BeanDefinitions.getUserApplicationServiceBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("jpa.FeriadoRepository.fragments#0", RepositoryComposition__BeanDefinitions.RepositoryFragments.getFragmentsBeanDefinition1());
    beanFactory.registerBeanDefinition("feriadoRepository", FeriadoRepository__BeanDefinitions.getFeriadoRepositoryBeanDefinition());
